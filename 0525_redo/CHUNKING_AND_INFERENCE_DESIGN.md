...
- `0525_redo/chunking/` contains PDF parsing, sectioning, asset extraction, text chunk construction, vector indexing, offline VLM table parsing, table-summary vector indexing, and retrieval hit-rate evaluation.
- `0525_redo/inference/` contains runtime RAG inference and RAGAS-style answer evaluation.
...
- Menu-guided sections: `0525_redo/chunking/AAPL_FY2025_menu_guided_sections.json`
- Section-linked assets: `0525_redo/chunking/AAPL_FY2025_section_assets.json`
- Text-only RAG chunks: `0525_redo/chunking/AAPL_FY2025_rag_chunks.json`
...
- Offline VLM table parse: `0525_redo/chunking/vlm_table_parse.py`
- Table summary index builder: `0525_redo/chunking/build_table_vector_db.py`
- Inference script: `0525_redo/inference/text_vector_rag_inference.py`
- Mixed inference eval: `0525_redo/inference/run_mixed_inference_eval.py`
- RAGAS-style mixed eval: `0525_redo/inference/eval_msft_mixed_ragas_style.py`
- MSFT mixed test set: `0525_redo/common/msft_fy2025_mixed_15_inference_test.json`
- MSFT table test set: `0525_redo/common/msft_fy2025_parsed_table_test_questions.json`
- MSFT table eval: `0525_redo/inference/eval_msft_table_test_questions.py`
- Inference evaluation script: `0525_redo/inference/eval_single_questions_ragas_style.py`
...
Script: `0525_redo/chunking/vlm_table_parse.py`
...
Script: `0525_redo/chunking/build_table_vector_db.py`
...
Chunk Studio uploads copy the PDF to `source.pdf` on disk, but indexing resolves the canonical filename from workspace `metadata.json` (`original_filename`) via `0525_redo/chunking/filing_metadata.py`. Existing workspaces can be patched with `0525_redo/chunking/patch_workspace_source_files.py`.
...
Test set: `0525_redo/common/msft_fy2025_parsed_table_test_questions.json`
...
- `0525_redo/inference/msft_fy2025_table_test_eval.json` — old pipeline
- `0525_redo/inference/msft_fy2025_table_test_eval_v2.json` — dual-path pipeline
...
Test set: `0525_redo/common/msft_fy2025_mixed_15_inference_test.json`
...
- `0525_redo/inference/msft_fy2025_mixed_5_anthropic_eval.json`
- `0525_redo/inference/msft_fy2025_mixed_5_ragas_style_eval.json`
- `0525_redo/inference/msft_fy2025_mixed_15_inference_results.json`
...
| CLI | `0525_redo/agent/agent.py` → `langchain_agent.run_langchain_agent` |
