...
sys.path.insert(0, str(ROOT / "main" / "chunking"))
...
def load_table30_questions() -> list[dict[str, Any]]:
    golden50 = json.loads((ROOT / "main/common/msft_fy2025_golden_eval_50.json").read_text())
    table20 = json.loads((ROOT / "main/common/msft_fy2025_golden_eval_table20.json").read_text())
